...
import { IProductsItem } from './best_selling_items_format';
...
export class BestSellingItemServiceService {
  private _url : string = "/assets/data/best-selling-items-data.json" 
  constructor(private http : HttpClient) { }
  
  best_selling_list(): Observable<IProductsItem[]>{
    return this.http.get<IProductsItem[]>(this._url);
  }
  // best_selling_list(){
  //   return [
  //     {
